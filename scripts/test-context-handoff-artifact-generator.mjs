...
try {
 ...
 const unavailable={...bundleInput,repository_state:{state:'unavailable',repository:'whatrune/sd-prompt-studio',workflow_identity_snapshot:handoffInput.workflow_identity,observed_at:at,attempt:{attempt_id:'attempt-1',source_ref:taskSource,attempted_at:at,method:'github_api',failure_reason:'source_unreachable',safe_diagnostic_code:'source_unreachable'}}}; unavailable.context_handoff_bundle_builder_input_ref=await artifacts.generateContextHandoffBundleBuilderInputRef(unavailable); assert.equal((await artifacts.buildContextHandoffBundleV1(unavailable)).result_kind,'incomplete')
