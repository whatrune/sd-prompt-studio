...
const unavailableDiagnosticFixtures = [
  { body: diagnosticParseFailureBody, expectedBody: mergeDecisionBody(), dispatch: mergeDecisionDispatch },
  { body: diagnosticOverflowBody, expectedBody: mergeDecisionBody(), dispatch: mergeDecisionDispatch },
  { body: mergeDecisionBody(), expectedBody: diagnosticConstructionExpectedBody, dispatch: diagnosticConstructionDispatch },
].map((fixture) => ({
  ...fixture,
