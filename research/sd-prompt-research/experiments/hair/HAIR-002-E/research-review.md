# HAIR-002-E Research Review

## Pair Decision

**COEXISTENCE_CANDIDATE** for **ponytail + long hair**.

A single tied tail remains distinct and below-shoulder extent is visible in all six treatment panels; every matched treatment is visibly longer.
...
| Treatment below-shoulder extent for coexistence | ≥5/6 | 6/6 | PASS |
| Treatment visibly longer for coexistence | ≥4/6 | 6/6 | PASS |
| Treatment ambiguity/artifact | ≤1/6 | 0/6 | PASS |
| Coexistence candidate | all coexistence thresholds | — | PASS |
| Main-suppression candidate | main absent/ambiguous ≥5/6 | 0/6 | FAIL |
| Long-suppression candidate | main retained and long extent absent ≥5/6 | 0/6 absent | FAIL |

## Interpretation Boundary

- `COEXISTENCE_CANDIDATE` describes this checkpoint/settings/seed sample only.
