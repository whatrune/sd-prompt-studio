...
try {
  ...
  const jsonlFile = path.join(reviewerWrapperTemp, 'output.jsonl')
  ...
  reviewerWrapperFailure = evaluateRoleOutputInvocationV1({
    dispatchFile, outputFile, jsonlFile, runId: REVIEW_RUN_ID, runAttempt: 2,
  })
...
const roleOutputMatrix = [
  ...
  reviewerOutput.next_action === 'POST_REVIEW' && !Object.hasOwn(reviewerOutput, 'bounded_metadata') && !Object.hasOwn(reviewerOutput, 'failure_evidence') && reviewerWrapperSuccess.next_action === 'POST_REVIEW' && reviewerSuccessProjectionCalls === 0 && !Object.hasOwn(reviewerWrapperSuccess, 'failure_evidence') && !Object.hasOwn(reviewerWrapperSuccess, 'bounded_metadata'),
