...
This human-facing template records implementation results and validation. Normal Task commit/publication uses the shared Normal Task Lifecycle contract; no separate terminal machine handoff is required.
