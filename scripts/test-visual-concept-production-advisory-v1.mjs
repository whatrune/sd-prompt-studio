...
try {
  ...
  check(!appSource.includes('Visual Concept risk advisories') && !appSource.includes('constraint_metadata.advisory_inspection'), 'App must not create a parallel advisory renderer or infer visibility from inspection output')
