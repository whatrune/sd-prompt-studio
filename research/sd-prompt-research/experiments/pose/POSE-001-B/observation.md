# COND-04 Prompt-Blind Observation Report
...
- Observed framing: cowboy_shot=3/6, full_body=3/6
- Body state: standing=3/6, unclear=3/6
...
- Feet visible: `none`
- Knees visible: `both`
- Support boundary visible: `absent`
- Seat or ground contact visible: `unclear`
