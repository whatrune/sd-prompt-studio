# HAIR-002-B Research Review

## Pair Decision

**LONG_SUPPRESSION_CANDIDATE** for **bob cut + long hair**.

The bob silhouette remains distinct in all six treatment panels, while no treatment panel extends below the shoulder line and no matched pair is visibly longer.
...
| Treatment below-shoulder extent for coexistence | ≥5/6 | 0/6 | FAIL |
| Treatment visibly longer for coexistence | ≥4/6 | 0/6 | FAIL |
...
| Long-suppression candidate | main retained and long extent absent ≥5/6 | 6/6 absent | PASS |

## Interpretation Boundary

- `LONG_SUPPRESSION_CANDIDATE` describes this checkpoint/settings/seed sample only.
