...
const input = (overrides = {}) => ({
  contract_version: 'context-health-evaluation-input-v1', context_health_input_ref: inputRef, policy_ref: policyRef, task_id: 'IMPLEMENT-CONTEXT-HEALTH-HANDOFF-CONTRACTS-001', assignment_revision: 1, role: 'backend_implementer', repository: 'whatrune/sd-prompt-studio', workflow_phase: 'implementation',
  ...
  workflow_identity: { canonical_task_record: source, dispatch_record: source, issue_binding: { state: 'bound', observed_at: observedAt, issue_url: 'https://github.com/whatrune/sd-prompt-studio/issues/156', provenance: {} }, pr_binding: { state: 'not_created', observed_at: observedAt, creation_record_ref: source }, branch_binding: { state: 'bound', observed_at: observedAt, branch_name: 'codex/implement-context-health-handoff-contracts', provenance: {} }, worktree_binding: { state: 'bound', observed_at: observedAt, worktree_path_ref: '.worktrees/context-health-handoff-contracts', provenance: {} }, head_binding: { state: 'bound', observed_at: observedAt, head_sha: 'a'.repeat(40), provenance: {} }, execution_binding: { state: 'not_applicable', observed_at: observedAt, basis_ref: source, non_applicability_reason: 'contract_not_required' } },
