...
try {
  ...
  assert(appSource.includes('className="saved-prompt-asset-main" onClick={()=>setSelectedSavedPrompt(saved)}'), 'Saved Prompt card bodies must update only the Inspector selection')
